...
app.get('/harvestFinance/pools', function (req, res) {
  https.get('https://api-ui.harvest.finance/pools?key=41e90ced-d559-4433-b390-af424fdc76d6', resp => {
    let data = '';
    resp.on('data', chunk => {
      data += chunk;
    });
...
console.log('Server listen on port: ' + (process.env.PORT ?  process.env.PORT : 8080));
